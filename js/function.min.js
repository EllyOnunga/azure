!(function (e) {
    ...
    if (
        ...
        e("a[href='#top']").length &&
            (e(document).on("click", "a[href='#top']", function () {
                return (e("html, body").animate({ scrollTop: 0 }, "slow"), !1);
            }),
            t.on("scroll", function () {
                e(window).scrollTop() > 300
                    ? e(".scroll-to-top").addClass("active")
                    : e(".scroll-to-top").removeClass("active");
                var t =
                    ((document.body.scrollTop || document.documentElement.scrollTop) /
                        (document.documentElement.scrollHeight - document.documentElement.clientHeight)) *
                    100;
                e(".scroll-progress").css("width", t + "%");
            })),
        ...
        new Swiper(".testimonial-slider .swiper", {
            ...
            loop: !0,
            autoplay: { delay: 5e3 },
            pagination: { el: ".testimonial-pagination", clickable: !0 },
            navigation: { nextEl: ".testimonial-button-next", prevEl: ".testimonial-button-prev" },
            breakpoints: { 768: { slidesPerView: 1 }, 991: { slidesPerView: 1 } },
        });
    }
    if (
        (e(".skills-progress-bar").length &&
            e(".skills-progress-bar").waypoint(
                function () {
        ...
        e("#herovideo").YTPlayer();
    if ((e(".counter").length && e(".counter").counterUp({ delay: 6, time: 3e3 }), e(".reveal").length)) {
        (gsap.registerPlugin(ScrollTrigger),
            document.querySelectorAll(".reveal").forEach((e) => {
                let t = e.querySelector("img"),
                    o = gsap.timeline({ scrollTrigger: { trigger: e, toggleActions: "play none none none" } });
                (o.set(e, { autoAlpha: 1 }),
                    o.from(e, 1, { xPercent: -100, ease: Power2.out }),
                    o.from(t, 1, { xPercent: 100, scale: 1, delay: -1, ease: Power2.out }));
            }));
    }
    ...
    var o = e(".parallaxie");
    (o.length && t.width() > 991 && t.width() > 768 && o.parallaxie({ speed: 0.55, offset: 0 }),
        e(".gallery-items").magnificPopup({
            delegate: "a",
            type: "image",
    ...
    var i = e("#contactForm");
    function l(t, o) {
        if (t) var r = "h4 text-success";
        else r = "h4 text-danger";
        e("#msgSubmit").removeClass().addClass(r).text(o);
    }
    i.validator({ focus: !1 }).on("submit", function (t) {
        t.isDefaultPrevented() ||
            (t.preventDefault(),
            e.ajax({
                type: "POST",
                url: "https://formspree.io/f/" + r,
                data: i.serialize(),
                dataType: "json",
                success: function (e) {
                    (i[0].reset(), l(!0, "Message Sent Successfully!"));
                },
                error: function (e) {
                    l(!1, "Did not connect to server.");
                },
            }));
    });
    var n = e("#reserveForm");
    function c(t, o) {
        if (t) var r = "h3 text-success";
        else r = "h3 text-danger";
        e("#msgSubmit").removeClass().addClass(r).text(o);
    }
    n.validator({ focus: !1 }).on("submit", function (t) {
        t.isDefaultPrevented() ||
            (t.preventDefault(),
            e.ajax({
                type: "POST",
                url: "https://formspree.io/f/" + a,
                data: n.serialize(),
                dataType: "json",
                success: function (e) {
                    (n[0].reset(), c(!0, "Message Sent Successfully!"));
                },
                error: function (e) {
                    c(!1, "Did not connect to server.");
                },
            }));
    });
    var d = e("#newslettersForm");
    (d.length &&
        d.validator({ focus: !1 }).on("submit", function (t) {
            t.isDefaultPrevented() ||
                (t.preventDefault(),
                e.ajax({
                    type: "POST",
                    url: "https://formspree.io/f/" + s,
                    data: d.serialize(),
                    dataType: "json",
                    success: function (e) {
                        (d[0].reset(), alert("Subscribed Successfully!"));
                    },
                    error: function (e) {
        ...
        t.on("load", function () {
            if (e(".gallery-item-boxes").length) {
                var t = e(".gallery-item-boxes").isotope({
                        itemSelector: ".gallery-item-box",
                        layoutMode: "masonry",
                        masonry: { columnWidth: 1 },
                    }),
                    o = e(".our-gallery-nav li a");
                (o.on("click", function (r) {
                    var a = e(this).attr("data-filter");
                    (t.isotope({ filter: a }),
                        o.removeClass("active-btn"),
