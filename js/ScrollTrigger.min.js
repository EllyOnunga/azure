...
!(function (e, t) {
    ...
    function E(e, t) {
        ...
        return (r = "scroll" + n) && C(e)
            ? Math.max(x[r], Se[r]) - (we["inner" + n] || x["client" + n] || Se["client" + n])
            : e[r] - e["offset" + n];
    }
    function F(e) {
    ...
    function na(e, t) {
        if (F(e)) {
            ...
            (n && (e.indexOf("%") > r && (n *= t / 100), (e = e.substr(0, r - 1))),
                (e = n + (e in g ? g[e] * t : ~e.indexOf("%") ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0)));
        }
        return e;
    }
    function oa(e, t, r, n, o, i, a) {
        ...
        return (
            ...
            (!g && d) || (b += (n === Xe ? y : w) + ":" + (i + parseFloat(f)) + "px;"),
    ...
    function Ja(e, t, r, n, o, i, a, s, l, c, f, u) {
        if (
            (G(e) && (e = e(s)),
            F(e) && "max" === e.substr(0, 3) && (e = u + ("=" === e.charAt(4) ? na("0" + e.substr(3), r) : 0)),
            H(e))
        )
            a && T(a, r, n, f, !0);
        else {
        ...
        if (i) {
            var b = e + r,
                y = i._isStart;
            ((u = "scroll" + n.d2),
                T(i, b, n, f, (y && 20 < b) || (!y && (f ? Math.max(Se[u], x[u]) : i.parentNode[u]) <= b + 1)),
                f && ((l = ea(a)), f && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + qe)));
        }
        return Math.round(e);
    }
    function Ma(l, e) {
    ...
    var xe,
        ...
        m = function _updateAll() {
            var e = Ve.length,
                ...
                r = Oe(),
                n = 50 <= r - u;
            for (n && (ze && !Pe && 200 < r - ze && ((ze = 0), v("scrollEnd")), (_e = u), (u = r)); t < e; t++)
        ...
        $e = function _setState(e) {
            for (var t, r, n = e.t.style, o = e.length, i = 0; i < o; i += 2)
                ((r = e[i + 1]),
                    (t = e[i]),
                    r ? (n[t] = r) : n[t] && n.removeProperty(t.replace(k, "-$1").toLowerCase()));
        },
        Ke = { left: 0, top: 0 },
    ...
    var _ =
        ((ScrollTrigger.prototype.init = function init(y, x) {
            if (((this.progress = 0), this.vars && this.kill(1), Fe)) {
                var d,
                    ...
                    Z,
                    $,
                    K = (y = da(F(y) || H(y) || y.nodeType ? { trigger: y } : y, Ue)).horizontal ? Je : Xe,
                    Q = y.onUpdate,
                    ee = y.toggleClass,
                    i = y.id,
                    te = y.onToggle,
                ...
                ((se *= 45),
                    ...
                    x &&
                        ((x.vars.lazy = !1),
                        x._initted || (!1 !== x.vars.immediateRender && x.render(-0.01, !0, !0)),
                                ...
                                if (!ze || (ze === U && !Pe)) {
                                    ...
                                    if (a <= S && T <= a) {
                                        ...
                                        d(
                                            ...
                                            {
                                                duration: f(
                                                    Ae((0.185 * Math.max(Ae(n - e), Ae(o - e))) / t / 0.05 || 0),
                                                ),
                                                ease: ce.ease || "power3",
                                                data: Math.abs(s - a),
                                                onComplete: function onComplete() {
                    ...
                    oe &&
                        (!1 === ie || ie === je || (ie = "flex" !== ba(oe.parentNode).display && Re),
                        (me.pin = oe),
                        !1 !== y.force3D && xe.set(oe, { force3D: !0 }),
                        (e = xe.core.getCache(oe)).spacer
                            ? (A = e.pinState)
                            : ((e.spacer = N = Te.createElement("div")),
                              N.setAttribute("class", "pin-spacer" + (i ? " pin-spacer-" + i : "")),
                              (e.pinState = A = Ga(oe))),
                    ...
                    (me.refresh = function (e) {
                        if (!Me && $)
                            if (oe && e && ze) ia(ScrollTrigger, "scrollEnd", be);
                                ...
                                if (
                                    ((T = Ja(m, ne, f, K, me.scroll(), k, M, me, u, ve, de, p) || (oe ? -0.001 : 0)),
                                    G(h) && (h = h(me)),
                                    F(h) &&
                                        !h.indexOf("+=") &&
                                        (~h.indexOf(" ")
                                            ? (h = (F(m) ? m.split(" ")[0] : "") + h)
                                            : ((d = na(h.substr(2), f)), (h = F(m) ? m : T + d), (v = ne))),
                                    (S =
                                        Math.max(
                                            T,
                                            Ja(
                                    ...
                                    for (l = b; l--; )
                                        (c = Ve[l]).pin === oe && c.start - c._pinPush < T && (g += c.end - c.start);
                                    if (
                                        ((T += g),
                                        (S += g),
                                        (me._pinPush = g),
                                        ...
                                        ie &&
                                            ...
                                            (q = ie === Re ? fa(oe, K) + O + g : 0) && (N.style[K.d] = q + qe),
                                            de && me.scroll(t)),
                                        de &&
                                            (((s = {
                                            ...
                                            (s[je] = s[je + Ge] = s[je + De] = s[je + Ne] = s[je + Be] = "0"),
                                            (s[Re] = n[Re]),
                                            (s[Re + Ge] = n[Re + Ge]),
                                            (s[Re + De] = n[Re + De]),
                                            (s[Re + Ne] = n[Re + Ne]),
                                ...
                                ((me.start = T),
                                    ...
                                    me.revert(!1),
                                    (Me = 0),
                                    r !== me.progress && (V && x.totalProgress(r, !0), (me.progress = r), me.update()),
                    ...
                    (me.update = function (e, t) {
                        var r,
                            ...
                            f = me.progress;
                        if (
                            (t && ((h = g), (g = s), ce && ((Y = X), (X = x && !ue ? x.totalProgress() : c))),
                            se && !c && oe && !Me && T < s + ((s - h) / (Oe() - _e)) * se && (c = 1e-4),
                            c !== f && $)
                        ) {
                            if (
                                ((i = (a = (r = me.isActive = !!c && c < 1) != (!!f && f < 1)) || !!c != !!f),
                    ...
                    (me.enable = function () {
                        $ ||
                            ...
                            x &&
                                (x.add ? xe.delayedCall(0.01, me.refresh) && (O = 0.01) && (T = S = 0) : me.refresh()));
                    }),
                    (me.disable = function (e) {
                        if (
                            ...
                            for (var t = Ve.length; t--; ) if (Ve[t].scroller === pe && Ve[t] !== me) return;
        ...
        (ScrollTrigger.register = function register(e) {
            if (
                ((xe = e || B()),
                A() && window.document && ((we = window), (Te = document), (x = Te.documentElement), (Se = Te.body)),
                xe &&
                    ((Ce = xe.utils.toArray),
                    (ke = xe.utils.clamp),
